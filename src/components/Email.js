...
import Emailbg from '../assets/images/emaibg.jpg'
    ...
    return (
        <EmailContainer>
            <EmailContent>
                ...
                <p>Sign up for our newsletter below to get $100 off on your first purchase </p>
                <form action="#">
                    <FormWrap>
                        <label htmlFor="email">
                            <input tyep="email" placeholder='Enter Your Email' id='email' />
                        </label>
